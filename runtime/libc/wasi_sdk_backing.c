...
// file operations
i32 wasi_unstable_path_open(i32 dirfd, u32 lookupflags, u32 path_off, u32 path_len, u32 oflags, u64 fs_rights_base,
                            u64 fs_rights_inheriting, u32 fdflags, u32 fd_off) {
    // get path
...
// process operations
__attribute__((noreturn)) void wasi_unstable_proc_exit(i32 exitcode) {
    exit(exitcode);
}
